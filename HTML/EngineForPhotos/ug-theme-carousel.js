/**
*                    © The script may be used and modified!
* 
* (1.) - Script now created by: (PsIxGG) & (psix15). 
* (2.) - Script sourced from here: (https://flickrembed.com/unitegallery/themes/carousel/ug-theme-carousel.js). Via site: (https://web.archive.org). 
*
*     /ᐠ｡ꞈ｡ᐟ\
*     ‾‾‾‾‾‾
**/
